# <p align="center">pyTelegramBotAPI for Google App Engine

<p align="center">A simple, but extensible Python implementation for the <a href="https://core.telegram.org/bots/api">Telegram Bot API</a>. Modified to use in Google App Engine
